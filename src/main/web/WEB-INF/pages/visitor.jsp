    ...
    <div class="dvheadertools">
        ...
        <ul class="headerultools">
            ...
            <li class="headerlitools_info headerlitools" style="background-color: #075597">
                ...
                游客<i style="margin-left: 8px;" class="icon-caret-down"></i>
...
<div class="dvcontent">
    ...
    <ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
        ...
        <li class="limenuitem">
            <i class="icon-cog menuicon"></i>游客菜单<b class="arrow icon-angle-down arrow-down"></b>
            <ul class="ulleftsubitems">
                <a href="seeInterview" target="right">
                    <li>查看面试邀请</li>
                </a>
                <a href="goUpdateResume" target="right">
                    <li>修改简历</li>
                </a>
    ...
    <div style="position: absolute; left: 191px; right: 20px; ">
        <iframe src="" scrolling="no"  width="100%" height="1200" name="right" border="none">
            <p>${requestScope.i_msg}</p>
        </iframe>
    </div>
</div>
