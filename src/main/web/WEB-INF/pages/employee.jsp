    ...
    <div class="dvheadertools">
        ...
        <ul class="headerultools">
            ...
            <li class="headerlitools_info headerlitools" style="background-color: #075597">
                ...
                员工<i style="margin-left: 8px;" class="icon-caret-down"></i>
...
<div class="dvcontent">
    ...
    <ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
        ...
        <li class="limenuitem">
            <i class="icon-cog menuicon"></i>员工菜单<b class="arrow icon-angle-down arrow-down"></b>
            <ul class="ulleftsubitems">
                <a href="showEmployeeMe" target="right">
                    <li>查看自己信息</li>
                </a>
                <a href="goDimission?empId=${sessionScope.employee.emp_id}" target="right">
                    <li>离职</li>
                </a>
                <a href="goAttendance" target="right">
                    <li>打卡</li>
                </a>
                <a href="goAddReconsider" target="right">
                    <li>薪资复议</li>
                </a>
                <a href="showTraining" target="right">
                    <li>查看培训信息</li>
                </a>
                <a href="showAwardPunish" target="right">
                    <li>查看奖惩信息</li>
                </a>
                <a href="showOtherEmp" target="right">
                    <li>查看员工信息</li>
                </a>
                <a href="showSalary" target="right"><li >查看薪资</li></a>
                <%--<a href="showSalary" target="right"><li >转正</li></a>--%>
            </ul>
        </li>
    </ul>
